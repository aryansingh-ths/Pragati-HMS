...
export default function App() {
  ...
  const hasAccess = (dept) => {
    ...
    if (dept === 'SALES' && (role === 'SALES_HEAD' || role === 'SALES_EXECUTIVE')) return true;
      ...
      <div className="min-h-screen bg-[#FDFBF7] text-slate-800 flex flex-col justify-between pt-24">
        ...
        <div className="flex-1">
          <Routes>
            ...
            <Route element={<ProtectedRoute isAllowed={userRole?.toUpperCase() === 'SALES_EXECUTIVE' || userRole?.toUpperCase() === 'SALES_HEAD' || userRole?.toUpperCase() === 'SALES' || userRole?.toUpperCase() === 'ADMIN' || userRole?.toUpperCase() === 'SUPER_ADMIN'} />}>
